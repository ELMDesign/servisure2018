...
(isset($context["icon"]) ? $context["icon"] : null)) ? ("linkicon__text") : ("linkicon__noicon")));
        // line 25
        if ((isset($context["title_only"]) ? $context["title_only"] : null)) {
            // line 26
            echo "  ";
...
";
            ...
            // line 28
            echo "  ";
            if (twig_in_filter((isset($context["position"]) ? $context["position"] : null), array(0 => "bottom", 1 => "right"))) {
                // line 29
                echo "    <span";
  ...
  ";
    ...
    {
        return new Twig_Source("", "modules/linkicon/templates/linkicon-item.html.twig", "/Volumes/Video_Drive/web/DrupalProjects/servisure-dev/docroot/modules/linkicon/templates/linkicon-item.html.twig");
    }
}
