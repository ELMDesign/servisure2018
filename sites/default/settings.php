 ...
 * @endcode
 */
$settings['hash_salt'] = '7th-DLR13dgLVpTUXciCr3GXzjiQCC9EfvMjEDUrOXEjYBdBL70suX4E--mb40vm6vn2_BDx0Q';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_servisure_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_servisure_dev_default.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
...
// (Drupal 5 or 6) or $databases (Drupal 7 or 8) as described in comments above.
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/servisure/servisure-settings.inc');
}
